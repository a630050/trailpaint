export default {
  ...
  'route.hintRightClick': '滑鼠右鍵點擊節點，可刪除自該點起之後的路線',
  ...
  'export.preview.aiHint': '複製後貼入 Midjourney、DALL-E 3 或 Stable Diffusion，即可生成對應風格的路線插畫地圖。',
  'export.ai.japanese': '日系手繪風',
  'export.ai.treasure': '藏寶圖風',
  'export.ai.kawaii': '療癒卡通風',
  'export.ai.minimal': '極簡線條風',
  ...
  'map.fitAll': '縮放至全域',
  'map.rotateCW': '旋轉地圖 30°',
  'map.rotateReset': '還原正北方向',
  'export.preview.downloadGpx': '下載 GPX',
