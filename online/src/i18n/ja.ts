export default {
  ...
  'route.hintRightClick': 'ポイントを右クリックするとそれ以降を削除',
  ...
  'export.preview.aiHint': 'Midjourney、DALL-E 3、または Stable Diffusion に貼り付けると、スタイル別のルートイラスト地図を生成できます。',
  'export.ai.japanese': '和風手描き',
  'export.ai.treasure': '宝の地図',
  'export.ai.kawaii': 'カワイイ',
  'export.ai.minimal': 'ミニマル線画',
  ...
  'map.fitAll': '全要素にフィット',
  'map.rotateCW': '地図を 30° 回転',
  'map.rotateReset': '北向きにリセット',
  'export.preview.downloadGpx': 'GPX をダウンロード',
